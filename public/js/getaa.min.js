...
var getAA=function(){function e(e){for(var t=0,a=e.length;a>t;t++)e[t].classList.remove("day-selected"),e[t].classList.add("day-unselected")}function t(t){for(var a=0,s=t.length;s>a;a++)t[a].addEventListener("click",function(){var a=this.id;if(this.classList.contains("day-unselected")){n("Fetching Meetings..."),c();var s=r(a);f(s)}e(t),this.classList.remove("day-unselected"),this.classList.add("day-selected")})}function a(e,t,a){var n=I.querySelector("#toast");t||(t=""),a||(a=2750);var s={message:e+t,timeout:a};n.MaterialSnackbar.showSnackbar(s)}function n(e){var t=I.querySelector("#toast"),a=I.querySelector(".mdl-snackbar__text");a.innerHTML=e,t.classList.add("mdl-snackbar--active")}function s(e){setTimeout(function(){var e=I.getElementById("toast");e.classList.remove("mdl-snackbar--active")},N*e)}function l(e){for(var t=0;t<w.length;t++)w[t].setMap(null);1==e&&(w=[])}function o(){var e=new Date,t=new Array(7);t[0]="sunday",t[1]="monday",t[2]="tuesday",t[3]="wednesday",t[4]="thursday",t[5]="friday",t[6]="saturday";var a=t[e.getDay()];return a}function r(e){for(var t=[],a=0;a<M.length;a++)M[a].val().day==e&&t.push(M[a]);return t}function i(e,t){window.setTimeout(function(){d(e);var t=new google.maps.LatLng(e.val().latitude,e.val().longitude),a=!1,n=!1,s=!1,l='<span class="bold caps">'+e.val().name+"<br>"+e.val().hour+e.val().min+" "+e.val().timeframe+'</span><br><span class="cap"><a href="http://maps.google.com/?q='+e.val().street+" "+e.val().city+" "+e.val().state+" "+e.val().zip+'">'+e.val().street+"<br>"+e.val().city+", "+e.val().state+"  "+e.val().zip+"</a><br>"+e.val().siteNotes+"</span>";switch(e.val().timeframe){case"am":a=!0;break;case"noon":n=!0;break;case"pm":s=!0}var o=new google.maps.Marker({position:t,map:k,day:e.val().day,meetingOpen:e.val().meetingOpen,meetingClosed:!e.val().meetingOpen,onlyMen:e.val().onlyMen,onlyWomen:e.val().onlyWomen,childcare:e.val().childcare,meditation:e.val().meditation,speaker:e.val().speaker,step:e.val().step,spanish:e.val().spanish,bigBook:e.val().bigBook,discussion:e.val().discussion,tradition:e.val().tradition,beginner:e.val().beginner,am:a,noon:n,pm:s,animation:google.maps.Animation.DROP});w.push(o),google.maps.event.addListener(o,"click",function(e,t){return function(){S.setContent(l),S.open(k,e)}}(o,e))},t)}function d(e){e.val().meetingOpen&&(O.dataset.badge=Number(O.dataset.badge)+1),e.val().meetingOpen||(A.dataset.badge=Number(A.dataset.badge)+1),e.val().onlyMen&&(D.dataset.badge=Number(D.dataset.badge)+1),e.val().onlyWomen&&(T.dataset.badge=Number(T.dataset.badge)+1),e.val().childcare&&(P.dataset.badge=Number(P.dataset.badge)+1),e.val().meditation&&(W.dataset.badge=Number(W.dataset.badge)+1),e.val().speaker&&(F.dataset.badge=Number(F.dataset.badge)+1),e.val().step&&(x.dataset.badge=Number(x.dataset.badge)+1),e.val().spanish&&(z.dataset.badge=Number(z.dataset.badge)+1),e.val().bigBook&&(H.dataset.badge=Number(H.dataset.badge)+1),e.val().discussion&&(_.dataset.badge=Number(_.dataset.badge)+1),e.val().tradition&&(G.dataset.badge=Number(G.dataset.badge)+1),e.val().beginner&&(R.dataset.badge=Number(R.dataset.badge)+1),"am"===e.val().timeframe&&(Y.dataset.badge=Number(Y.dataset.badge)+1),"noon"===e.val().timeframe&&(U.dataset.badge=Number(U.dataset.badge)+1),"pm"===e.val().timeframe&&(Z.dataset.badge=Number(Z.dataset.badge)+1),e.val().name&&(j.dataset.badge=Number(j.dataset.badge)+1)}function c(){for(var e=0,t=J.length;t>e;e++)J[e].dataset.badge="0"}function g(){for(var e=0,t=J.length;t>e;e++)J[e].MaterialCheckbox.check();for(var a=I.querySelector(".day-selected").id,e=0,n=w.length;n>e;e++)w[e].day===a&&w[e].setMap(k)}function u(){for(var e=0,t=J.length;t>e;e++)J[e].MaterialCheckbox.uncheck();l()}function m(e){for(var t=0,a=e.length;a>t;t++)e[t].addEventListener("click",function(){"every"===this.id?(this.checked&&g(),this.checked||u()):(this.checked&&y("add",this.id.toString()),this.checked||y("remove",this.id.toString()))})}function y(e,t){switch(t){case"openMeeting":t="meetingOpen";break;case"closedMeeting":t="meetingClosed";break;case"mensOnly":t="onlyMen";break;case"womensOnly":t="onlyWomen"}for(var a=0,n=w.length;n>a;a++)if(w[a][t])switch(e){case"add":w[a].setMap(k);break;case"remove":w[a].setMap(null)}}function b(e,t,a){t.setPosition(a),t.setContent(e?"Error: The Geolocation service failed.":"Error: Your browser doesn't support geolocation.")}function v(e,t,a){var s=[];n("Fetching Meetings...");var l=B.query({center:[e,t],radius:C});l.on("key_entered",function(e,t){s.push(e)}),l.on("ready",function(){p(s).then(function(e){var t=r(a);f(t)},function(e){console.log(e)})})}function p(e){return Promise.all(e.map(h))}function h(e){var t=E.child(e);return t.once("value").then(function(e){M.push(e)},function(e){a("Error Fethcing Meetings: "+e)})}function f(e){l(!0);for(var t=0;t<e.length;t++)t===e.length-1&&s(t),i(e[t],t*N)}var k,S,L={},q=new Firebase("https://ack.firebaseio.com"),B=new GeoFire(q.child("geofire")),E=q.child("meetings"),w=[],M=[],I=document,N=10,C=96;L.ingredient="Bacon Strips",L.initMap=function(){var e=o();k=new google.maps.Map(I.getElementById("map"),{zoom:11,minZoom:10,mapTypeControl:!1}),S=new google.maps.InfoWindow({}),navigator.geolocation?navigator.geolocation.getCurrentPosition(function(t){var a=t.coords.latitude,n=t.coords.longitude,s={lat:a,lng:n};S.setPosition(s),S.setContent("You are here."),k.setCenter(s),I.getElementById("meetings-manager").style.display="initial",I.getElementById("report-error").style.display="initial",I.getElementById("rack-logo").style.display="initial",getAA.initMenu(e),v(a,n,e)},function(){b(!0,S,k.getCenter())}):b(!1,S,k.getCenter())},L.initMenu=function(e){var a=I.getElementById("menu"),n=I.querySelector(".actionButtonTop"),s=I.querySelector(".menuIcon"),l=I.querySelector("#sunday"),o=I.querySelector("#monday"),r=I.querySelector("#tuesday"),i=I.querySelector("#wednesday"),d=I.querySelector("#thursday"),c=I.querySelector("#friday"),g=I.querySelector("#saturday");switch(e){case"sunday":l.classList.toggle("day-unselected"),l.classList.toggle("day-selected");break;case"monday":o.classList.toggle("day-unselected"),o.classList.toggle("day-selected");break;case"tuesday":r.classList.toggle("day-unselected"),r.classList.toggle("day-selected");break;case"wednesday":i.classList.toggle("day-unselected"),i.classList.toggle("day-selected");break;case"thursday":d.classList.toggle("day-unselected"),d.classList.toggle("day-selected");break;case"friday":c.classList.toggle("day-unselected"),c.classList.toggle("day-selected");break;case"saturday":g.classList.toggle("day-unselected"),g.classList.toggle("day-selected")}var u=[l,o,r,i,d,c,g];t(u),s.className+=" menuIconDown",n.addEventListener("click",function(){a.classList.toggle("menuHidden"),a.classList.toggle("menuShown"),s.classList.toggle("flip"),s.classList.toggle("menuIconDown"),s.classList.toggle("menuIconUp")})};var O=I.getElementById("lblOpenMeeting"),A=I.getElementById("lblClosedMeeting"),D=I.getElementById("lblMensOnly"),T=I.getElementById("lblWomensOnly"),P=I.getElementById("lblChildcare"),W=I.getElementById("lblMeditation"),F=I.getElementById("lblSpeaker"),x=I.getElementById("lblStep"),z=I.getElementById("lblSpanish"),H=I.getElementById("lblBigBook"),_=I.getElementById("lblDiscussion"),G=I.getElementById("lblTradition"),R=I.getElementById("lblBeginner"),Y=I.getElementById("lblAm"),U=I.getElementById("lblNoon"),Z=I.getElementById("lblPm"),j=I.getElementById("lblEvery"),J=[O,A,D,T,P,W,F,x,z,H,_,G,R,Y,U,Z,j],K=I.querySelector("#openMeeting"),Q=I.querySelector("#closedMeeting"),V=I.querySelector("#mensOnly"),X=I.querySelector("#womensOnly"),$=I.querySelector("#childcare"),ee=I.querySelector("#meditation"),te=I.querySelector("#speaker"),ae=I.querySelector("#step"),ne=I.querySelector("#spanish"),se=I.querySelector("#bigBook"),le=I.querySelector("#discussion"),oe=I.querySelector("#tradition"),re=I.querySelector("#beginner"),ie=I.querySelector("#am"),de=I.querySelector("#noon"),ce=I.querySelector("#pm"),ge=I.querySelector("#every"),ue=[K,Q,V,X,$,ee,te,ae,ne,se,le,oe,re,ie,de,ce,ge];return I.addEventListener("DOMContentLoaded",function(e){window.snackbarContainer=I.querySelector("#toast"),window.componentHandler.upgradeAllRegistered(),m(ue)}),L}();