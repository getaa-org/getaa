...
var getAA=function(){function e(e,t){var a={lat:e,lng:t},n=i(),s=A.getElementById("change-location"),l=A.getElementById("landing-card"),o=A.getElementById("close-landing-card");q.setPosition(a),q.setContent("You are here."),B.setCenter(a),l.style.display="none",A.getElementById("meetings-manager").style.display="inline",A.getElementById("report-error").style.display="inline",A.getElementById("rack-logo").style.display="inline",A.getElementById("btnMenu").style.display="inline",s.style.display="inline",getAA.initMenu(n),k(e,t,n),s.addEventListener("click",function(){l.style.display="inline"}),o.addEventListener("click",function(){l.style.display="none"})}function t(e){for(var t=0,a=e.length;a>t;t++)e[t].classList.remove("day-selected"),e[t].classList.add("day-unselected")}function a(e){for(var a=0,n=e.length;n>a;a++)e[a].addEventListener("click",function(){var a=this.id;if(this.classList.contains("day-unselected")){s("Fetching Meetings..."),g();var n=r(a);L(n)}t(e),this.classList.remove("day-unselected"),this.classList.add("day-selected")})}function n(e,t,a){var n=A.querySelector("#toast");t||(t=""),a||(a=2750);var s={message:e+t,timeout:a};n.MaterialSnackbar.showSnackbar(s)}function s(e){var t=A.querySelector("#toast"),a=A.querySelector(".mdl-snackbar__text");a.innerHTML=e,t.classList.add("mdl-snackbar--active")}function l(e){setTimeout(function(){var e=A.getElementById("toast");e.classList.remove("mdl-snackbar--active")},D*e)}function o(e){for(var t=0;t<C.length;t++)C[t].setMap(null);1==e&&(C=[])}function i(){var e=new Date,t=new Array(7);t[0]="sunday",t[1]="monday",t[2]="tuesday",t[3]="wednesday",t[4]="thursday",t[5]="friday",t[6]="saturday";var a=t[e.getDay()];return a}function r(e){for(var t=[],a=0;a<O.length;a++)O[a].val().day==e&&t.push(O[a]);return t}function d(e,t){window.setTimeout(function(){c(e);var t=new google.maps.LatLng(e.val().latitude,e.val().longitude),a=!1,n=!1,s=!1,l='<span class="bold caps">'+e.val().name+"<br>"+e.val().hour+e.val().min+" "+e.val().timeframe+'</span><br><span class="cap"><a href="http://maps.google.com/?q='+e.val().street+" "+e.val().city+" "+e.val().state+" "+e.val().zip+'">'+e.val().street+"<br>"+e.val().city+", "+e.val().state+"  "+e.val().zip+"</a><br>"+e.val().siteNotes+"</span>";switch(e.val().timeframe){case"am":a=!0;break;case"noon":n=!0;break;case"pm":s=!0}var o=new google.maps.Marker({position:t,map:B,day:e.val().day,meetingOpen:e.val().meetingOpen,meetingClosed:!e.val().meetingOpen,onlyMen:e.val().onlyMen,onlyWomen:e.val().onlyWomen,childcare:e.val().childcare,meditation:e.val().meditation,speaker:e.val().speaker,step:e.val().step,spanish:e.val().spanish,bigBook:e.val().bigBook,discussion:e.val().discussion,tradition:e.val().tradition,beginner:e.val().beginner,am:a,noon:n,pm:s,animation:google.maps.Animation.DROP});C.push(o),google.maps.event.addListener(o,"click",function(e,t){return function(){q.setContent(l),q.open(B,e)}}(o,e))},t)}function c(e){e.val().meetingOpen&&(P.dataset.badge=Number(P.dataset.badge)+1),e.val().meetingOpen||(T.dataset.badge=Number(T.dataset.badge)+1),e.val().onlyMen&&(W.dataset.badge=Number(W.dataset.badge)+1),e.val().onlyWomen&&(z.dataset.badge=Number(z.dataset.badge)+1),e.val().childcare&&(G.dataset.badge=Number(G.dataset.badge)+1),e.val().meditation&&(R.dataset.badge=Number(R.dataset.badge)+1),e.val().speaker&&(x.dataset.badge=Number(x.dataset.badge)+1),e.val().step&&(H.dataset.badge=Number(H.dataset.badge)+1),e.val().spanish&&(Y.dataset.badge=Number(Y.dataset.badge)+1),e.val().bigBook&&(_.dataset.badge=Number(_.dataset.badge)+1),e.val().discussion&&(Z.dataset.badge=Number(Z.dataset.badge)+1),e.val().tradition&&(j.dataset.badge=Number(j.dataset.badge)+1),e.val().beginner&&(K.dataset.badge=Number(K.dataset.badge)+1),"am"===e.val().timeframe&&(U.dataset.badge=Number(U.dataset.badge)+1),"noon"===e.val().timeframe&&(J.dataset.badge=Number(J.dataset.badge)+1),"pm"===e.val().timeframe&&(Q.dataset.badge=Number(Q.dataset.badge)+1),e.val().name&&(V.dataset.badge=Number(V.dataset.badge)+1)}function g(){for(var e=0,t=X.length;t>e;e++)X[e].dataset.badge="0"}function u(){for(var e=0,t=X.length;t>e;e++)X[e].MaterialCheckbox.check();for(var a=A.querySelector(".day-selected").id,e=0,n=C.length;n>e;e++)C[e].day===a&&C[e].setMap(B)}function y(){for(var e=0,t=X.length;t>e;e++)X[e].MaterialCheckbox.uncheck();o()}function m(){pe.addEventListener("click",function(){b(fe.value)?v(fe.value):n("Address contains invalid characters")}),fe.onkeypress=function(e){var t=e||window.event,a=t.which||t.keyCode;"13"==a&&pe.click()}}function b(e){return/[A-Za-z0-9'\.\-\s\,]/.test(e)}function v(t){var a=new google.maps.Geocoder;a.geocode({address:t},function(t,a){if(a===google.maps.GeocoderStatus.OK){myResult=t[0].geometry.location;var s=myResult.toString().slice(1,-1).split(", "),l=parseFloat(s[0]),o=parseFloat(s[1]);e(l,o)}else n("Location not found.  Please adjust address.  Error: ",a)})}function p(e){for(var t=0,a=e.length;a>t;t++)e[t].addEventListener("click",function(){"every"===this.id?(this.checked&&u(),this.checked||y()):(this.checked&&f("add",this.id.toString()),this.checked||f("remove",this.id.toString()))})}function f(e,t){switch(t){case"openMeeting":t="meetingOpen";break;case"closedMeeting":t="meetingClosed";break;case"mensOnly":t="onlyMen";break;case"womensOnly":t="onlyWomen"}for(var a=0,n=C.length;n>a;a++)if(C[a][t])switch(e){case"add":C[a].setMap(B);break;case"remove":C[a].setMap(null)}}function h(e,t,a){t.setPosition(a),t.setContent(e?"Error: The Geolocation service failed.":"Error: Your browser doesn't support geolocation.")}function k(e,t,a){var n=[],o=M.query({center:[e,t],radius:F});o.on("key_entered",function(e,t){n.push(e)}),o.on("ready",function(){n.length>0?(s("Fetching Meetings..."),S(n).then(function(e){var t=r(a);L(t)},function(e){console.log(e)})):(s('No area meetings found.  You are encouraged to volunteer to add them.  Click <a href="/admin">Meetings Manager</a> to become a site administrator.'),l(2e3))})}function S(e){return Promise.all(e.map(E))}function E(e){var t=N.child(e);return t.once("value").then(function(e){O.push(e)},function(e){n("Error Fethcing Meetings: "+e)})}function L(e){o(!0);for(var t=0;t<e.length;t++)t===e.length-1&&l(t),d(e[t],t*D)}var B,q,w={},I=new Firebase("https://ack.firebaseio.com"),M=new GeoFire(I.child("geofire")),N=I.child("meetings"),C=[],O=[],A=document,D=10,F=96;w.initMap=function(){B=new google.maps.Map(A.getElementById("map"),{zoom:12,minZoom:10,mapTypeControl:!1}),q=new google.maps.InfoWindow({}),navigator.geolocation?navigator.geolocation.getCurrentPosition(function(t){lat=t.coords.latitude,lng=t.coords.longitude,e(lat,lng)},function(){h(!0,q,B.getCenter())}):h(!1,q,B.getCenter())},w.initMenu=function(e){var t=A.getElementById("menu"),n=A.querySelector(".actionButtonTop"),s=A.querySelector(".menuIcon"),l=A.querySelector("#sunday"),o=A.querySelector("#monday"),i=A.querySelector("#tuesday"),r=A.querySelector("#wednesday"),d=A.querySelector("#thursday"),c=A.querySelector("#friday"),g=A.querySelector("#saturday");switch(e){case"sunday":l.classList.toggle("day-unselected"),l.classList.toggle("day-selected");break;case"monday":o.classList.toggle("day-unselected"),o.classList.toggle("day-selected");break;case"tuesday":i.classList.toggle("day-unselected"),i.classList.toggle("day-selected");break;case"wednesday":r.classList.toggle("day-unselected"),r.classList.toggle("day-selected");break;case"thursday":d.classList.toggle("day-unselected"),d.classList.toggle("day-selected");break;case"friday":c.classList.toggle("day-unselected"),c.classList.toggle("day-selected");break;case"saturday":g.classList.toggle("day-unselected"),g.classList.toggle("day-selected")}var u=[l,o,i,r,d,c,g];a(u),s.className+=" menuIconDown",n.addEventListener("click",function(){t.classList.toggle("menuHidden"),t.classList.toggle("menuShown"),s.classList.toggle("flip"),s.classList.toggle("menuIconDown"),s.classList.toggle("menuIconUp")})};var P=A.getElementById("lblOpenMeeting"),T=A.getElementById("lblClosedMeeting"),W=A.getElementById("lblMensOnly"),z=A.getElementById("lblWomensOnly"),G=A.getElementById("lblChildcare"),R=A.getElementById("lblMeditation"),x=A.getElementById("lblSpeaker"),H=A.getElementById("lblStep"),Y=A.getElementById("lblSpanish"),_=A.getElementById("lblBigBook"),Z=A.getElementById("lblDiscussion"),j=A.getElementById("lblTradition"),K=A.getElementById("lblBeginner"),U=A.getElementById("lblAm"),J=A.getElementById("lblNoon"),Q=A.getElementById("lblPm"),V=A.getElementById("lblEvery"),X=[P,T,W,z,G,R,x,H,Y,_,Z,j,K,U,J,Q,V],$=A.querySelector("#openMeeting"),ee=A.querySelector("#closedMeeting"),te=A.querySelector("#mensOnly"),ae=A.querySelector("#womensOnly"),ne=A.querySelector("#childcare"),se=A.querySelector("#meditation"),le=A.querySelector("#speaker"),oe=A.querySelector("#step"),ie=A.querySelector("#spanish"),re=A.querySelector("#bigBook"),de=A.querySelector("#discussion"),ce=A.querySelector("#tradition"),ge=A.querySelector("#beginner"),ue=A.querySelector("#am"),ye=A.querySelector("#noon"),me=A.querySelector("#pm"),be=A.querySelector("#every"),ve=[$,ee,te,ae,ne,se,le,oe,ie,re,de,ce,ge,ue,ye,me,be],pe=A.getElementById("locate-submit"),fe=A.querySelector("#manual-location");return A.addEventListener("DOMContentLoaded",function(e){window.snackbarContainer=A.querySelector("#toast"),window.componentHandler.upgradeAllRegistered(),p(ve),m()}),w}();
